...
package com.example.pickerclickcar.time;
...
import com.example.pickerclickcar.HapticFeedbackController;
import com.example.pickerclickcar.R;
import com.example.pickerclickcar.Utils;
import com.example.pickerclickcar.time.RadialPickerLayout.OnValueSelectedListener;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mUnselectedColor =
                res.getColor(mThemeDark? android.R.color.white : R.color.blue_focused);
